...
export class WebgpuShader {
     ...
     */
    constructor(shader: import("../shader.js").Shader);
    /**
    ...
    shader: import("../shader.js").Shader;
     ...
     */
    restoreContext(device: import("../graphics-device.js").GraphicsDevice, shader: import("../shader.js").Shader): void;
}
