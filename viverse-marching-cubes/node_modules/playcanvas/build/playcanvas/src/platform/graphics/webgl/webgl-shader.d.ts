...
export class WebglShader {
     ...
     */
    destroy(shader: import("../shader.js").Shader): void;
     ...
     */
    restoreContext(device: import("./webgl-graphics-device.js").WebglGraphicsDevice, shader: import("../shader.js").Shader): void;
    /**
     ...
     */
    compile(device: import("./webgl-graphics-device.js").WebglGraphicsDevice, shader: import("../shader.js").Shader): void;
    /**
     ...
     * @param {import('../shader.js').Shader} shader - The shader to compile.
     */
    link(device: import("./webgl-graphics-device.js").WebglGraphicsDevice, shader: import("../shader.js").Shader): void;
    /**
     ...
     */
    finalize(device: import("./webgl-graphics-device.js").WebglGraphicsDevice, shader: import("../shader.js").Shader): boolean;
    /**
     ...
     */
    isLinked(device: import("./webgl-graphics-device.js").WebglGraphicsDevice): boolean;
    /**
