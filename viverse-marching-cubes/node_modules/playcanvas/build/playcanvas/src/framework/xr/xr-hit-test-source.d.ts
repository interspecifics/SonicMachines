...
export class XrHitTestSource extends EventHandler {
     ...
     * @ignore
     */
    constructor(manager: import("./xr-manager.js").XrManager, xrHitTestSource: XRHitTestSource, transient: boolean, inputSource?: null | import("./xr-input-source.js").XrInputSource);
    /**
