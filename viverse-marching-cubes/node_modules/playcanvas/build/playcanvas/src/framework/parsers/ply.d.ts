...
export class PlyParser {
     ...
     */
    constructor(device: import("../../platform/graphics/graphics-device.js").GraphicsDevice, assets: import("../asset/asset-registry.js").AssetRegistry, maxRetries: number);
    ...
    load(url: {
        load: string;
        original: string;
    }, callback: import("../handlers/handler.js").ResourceHandlerCallback, asset: import("../asset/asset.js").Asset): Promise<void>;
    /**
