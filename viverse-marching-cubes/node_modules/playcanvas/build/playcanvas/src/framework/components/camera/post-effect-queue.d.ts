...
export class PostEffectQueue {
     ...
     */
    constructor(app: import("../../app-base.js").AppBase, camera: import("./component.js").CameraComponent);
    app: import("../../app-base.js").AppBase;
    camera: import("./component.js").CameraComponent;
    /**
     ...
     */
    addEffect(effect: import("../../../scene/graphics/post-effect.js").PostEffect): void;
    _sourceTarget: any;
    _newPostEffect: import("../../../scene/graphics/post-effect.js").PostEffect;
    /**
     ...
     * to remove.
     */
    removeEffect(effect: import("../../../scene/graphics/post-effect.js").PostEffect): void;
