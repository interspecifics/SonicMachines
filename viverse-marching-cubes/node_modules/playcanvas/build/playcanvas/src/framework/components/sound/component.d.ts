...
export class SoundComponent extends Component {
     ...
     * to.
     */
    constructor(system: import("./system.js").SoundComponentSystem, entity: import("../../entity.js").Entity);
    /** @private */
    private _volume;
    /** @private */
    private _pitch;
     ...
     * this.entity.sound.play('beep');
     */
    play(name: string): import("../../../platform/sound/instance.js").SoundInstance | null;
    /**
