 ...
 */
export function assignAttributesToScript(app: import("../../framework/application.js").Application, attributeSchemaMap: {
    [x: string]: AttributeSchema;
}, data: {
    [x: string]: any;
}, script: import("../../framework/script/script.js").Script): void;
 ...
 */
declare function attributeToValue(app: import("../../framework/application.js").Application, schema: AttributeSchema, value: any, current: any): any;
export {};
