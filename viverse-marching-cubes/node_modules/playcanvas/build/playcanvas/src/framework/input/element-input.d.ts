...
export class ElementSelectEvent extends ElementInputEvent {
     ...
     */
    constructor(event: XRInputSourceEvent, element: import("../components/element/component.js").ElementComponent, camera: import("../components/camera/component.js").CameraComponent, inputSource: import("../xr/xr-input-source.js").XrInputSource);
    /**
