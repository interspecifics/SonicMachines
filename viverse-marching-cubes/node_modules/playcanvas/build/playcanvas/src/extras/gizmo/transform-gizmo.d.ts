...
export type CameraComponent = import("../../framework/components/camera/component.js").CameraComponent;
export type Layer = import("../../scene/layer.js").Layer;
...
export class TransformGizmo extends Gizmo {
     ...
     */
    protected _shapes: {
        [x: string]: import("./shape/shape.js").Shape;
    };
    /**
