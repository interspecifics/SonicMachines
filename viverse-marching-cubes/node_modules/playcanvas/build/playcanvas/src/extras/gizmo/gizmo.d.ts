export type AppBase = import("../../framework/app-base.js").AppBase;
export type GraphNode = import("../../scene/graph-node.js").GraphNode;
export type GraphicsDevice = import("../../platform/graphics/graphics-device.js").GraphicsDevice;
export type MeshInstance = import("../../scene/mesh-instance.js").MeshInstance;
export type Shape = import("./shape/shape.js").Shape;
/**
