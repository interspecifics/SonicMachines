...
export class Batch {
     ...
     */
    constructor(meshInstances: import("../mesh-instance.js").MeshInstance[], dynamic: boolean, batchGroupId: number);
    /** @private */
    private _aabb;
    /**
     ...
     */
    origMeshInstances: import("../mesh-instance.js").MeshInstance[];
    /**
     * A single combined mesh instance, the result of batching.
     *
     * @type {import('../mesh-instance.js').MeshInstance}
     */
    meshInstance: import("../mesh-instance.js").MeshInstance;
    /**
