...
export class FrameGraph {
     ...
     */
    renderTargetMap: Map<import("../platform/graphics/render-target.js").RenderTarget, import("../platform/graphics/render-pass.js").RenderPass>;
    /**
     ...
     * pass to add.
     */
    addRenderPass(renderPass: import("../platform/graphics/render-pass.js").RenderPass): void;
    reset(): void;
    compile(): void;
